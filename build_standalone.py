...
# Fail before changing outputs if a generated external asset is missing/corrupt.
asset_dir = root / 'assets' / 'rendering'
asset_manifest = json.loads((asset_dir / 'manifest.json').read_text())
